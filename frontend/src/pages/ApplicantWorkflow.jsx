              ...
              <div className="bg-card-bg rounded-2xl p-8 md:p-10 lg:p-12 border border-border-color shadow-sm flex flex-col md:flex-row items-center justify-between mt-2 gap-8 transition-all hover:shadow-md">
                <div className="max-w-[540px] text-center md:text-left">
                  <h2 className="text-2xl md:text-3xl font-bold text-navy mb-3 tracking-tight">
                    Ku soo dhawoow, {user?.fullName?.split(' ')[0] || 'Muwaadin'}
                  </h2>
                  <p className="text-[15px] text-text-muted leading-relaxed font-medium">
                    Bilow codsigaaga fasaxa dhismaha si aad u hesho ogolaansho degdeg ah oo la xiriira mashaariicdaada.
                  </p>
                </div>
                <button
                ...
                >
                  <Plus size={20} strokeWidth={3} /> Codso Fasax Cusub
                </button>
              </div>

              <div>
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-[11px] font-bold text-text-muted uppercase tracking-[0.1em]">Codsiyadii U Dambeeyay</h3>
                  <button className="text-[12px] font-bold text-navy hover:underline tracking-wide">Dhamaan</button>
                </div>
                  ...
                  <table className="w-full min-w-[700px] text-left border-collapse">
                    <thead>
                      <tr className="border-b border-border-color bg-table-header-bg/30">
                        <th className="px-6 py-4 text-[10px] font-bold text-text-muted uppercase tracking-[0.1em]">Nooca Dhismaha</th>
                        <th className="px-6 py-4 text-[10px] font-bold text-text-muted uppercase tracking-[0.1em]">Taariikhda</th>
                        <th className="px-6 py-4 text-[10px] font-bold text-text-muted uppercase tracking-[0.1em]">ID-ga Codsiga</th>
                        <th className="px-6 py-4 text-[10px] font-bold text-text-muted uppercase tracking-[0.1em]">Xaaladda</th>
                        <th className="px-6 py-4 text-[10px] font-bold text-text-muted uppercase tracking-[0.1em] text-right">Ficilada</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-border-color bg-card-bg">
                      {loading ? (
                        <tr>
                          <td colSpan="5" className="px-6 py-10 text-center text-text-muted font-medium italic text-[13px]">Xogta waa soo socotaa...</td>
                        </tr>
                        ...
                        <tr>
                          <td colSpan="5" className="px-6 py-10 text-center text-text-muted font-black italic text-[13px] opacity-40">Wax codsi ah lagama helin.</td>
                        </tr>
                      ) : (
                        applications.filter(app =>
                          app.applicationId.toLowerCase().includes(searchTerm.toLowerCase()) ||
                          ...
                          return (
                            <tr key={app._id} className="hover:bg-table-header-bg/50 transition-colors">
                              <td className="px-6 py-4">
                                ...
                                <p className="text-[11px] text-text-muted italic">{app.formData.district} Degmada</p>
                              </td>
                              ...
                              <td className="px-6 py-4">
                                <span className={`px-2.5 py-1 rounded-full text-[10px] font-bold flex w-max items-center gap-1.5 ${styles.bg}`}>
                                  ...
                                  {app.status === 'Pending' ? 'Gadaal loo dhigay' : app.status}
                                </span>
                              </td>
          ...
          <>
            <header className="w-full bg-card-bg border-b border-border-color px-4 lg:px-8 h-[72px] flex justify-between items-center sticky top-0 z-50 shrink-0 shadow-sm overflow-x-auto">
              <div className="flex items-center gap-2 lg:gap-3 shrink-0">
                ...
                <h1 className="font-bold text-[14px] text-navy tracking-wide whitespace-nowrap">Xariirka Muwaadinka Muqdisho</h1>
              </div>
              <div className="flex items-center gap-6 lg:gap-8 text-[11px] lg:text-[12px] font-semibold text-text-muted tracking-wide pl-4 lg:pl-0 shrink-0">
                ...
                <button className="text-text-muted/50 hidden md:block">Adeegyada</button>
                <button className="text-text-muted whitespace-nowrap">Codsiyadayda</button>
              </div>
            </header>

            <div className="p-4 sm:p-6 lg:p-8 w-full max-w-[880px] mx-auto pb-24">
              <div className="mb-8">
                <h1 className="text-[22px] lg:text-[26px] font-bold text-navy tracking-tight mb-2">Codsiga Fasaxa Dhismaha</h1>
                <p className="text-[13px] lg:text-[14px] text-text-muted font-medium leading-relaxed">Fadlan iska xaqiiji in dhammaan xogta aad hoos ku galiso ay tahay sax</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6 lg:space-y-8">
                ...
                <section className="bg-card-bg rounded-[10px] shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)] border border-navy/10 overflow-hidden">
                  <div className="bg-table-header-bg border-b border-navy/10 px-6 py-4 flex items-center gap-3">
                    ...
                    <h2 className="font-bold text-[14px] text-navy tracking-wide">1. Macluumaadka Codsadaha</h2>
                  </div>
                  <div className="p-4 sm:p-6 lg:p-8 grid grid-cols-1 md:grid-cols-2 gap-y-6 lg:gap-y-8 gap-x-8">
                    <div className="col-span-1 md:col-span-2">
                      <label className="block text-[12px] font-bold text-navy mb-2">Magaca oo Dhamaystiran</label>
                      <input disabled={isReadOnly} type="text" name="fullName" value={formData.fullName} onChange={handleChange} placeholder="Magacaaga oo buuxa qor" className="w-full p-3 text-[14px] bg-card-bg border border-border-color rounded-md focus:ring-2 focus:ring-navy/20 focus:border-navy outline-none font-medium text-text-main shadow-sm transition-shadow disabled:opacity-50" required />
                    </div>
                    <div>
                      <label className="block text-[12px] font-bold text-navy mb-2">Lambarka Taleefanka</label>
                    ...
                    <div>
                      <label className="block text-[12px] font-bold text-navy mb-2">Ciwaanka Iimaylka</label>
                      <input disabled={isReadOnly} type="email" name="email" value={formData.email} onChange={handleChange} placeholder="magac@meel.com" className="w-full p-3 text-[14px] bg-card-bg border border-border-color rounded-md focus:ring-2 focus:ring-navy/20 focus:border-navy outline-none font-medium text-text-main shadow-sm transition-shadow disabled:opacity-50" required />
                    </div>
                  </div>
                </section>
                ...
                <section className="bg-card-bg rounded-[10px] shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)] border border-navy/10 overflow-hidden">
                  <div className="bg-table-header-bg border-b border-navy/10 px-6 py-4 flex items-center gap-3">
                    ...
                    <h2 className="font-bold text-[14px] text-navy tracking-wide">2. Faahfaahinta Mashruuca</h2>
                  </div>
                  <div className="p-4 sm:p-6 lg:p-8 grid grid-cols-1 md:grid-cols-2 gap-y-6 lg:gap-y-8 gap-x-6">
                    <div>
                      <label className="block text-[12px] font-bold text-navy mb-2">Lambarka Booska</label>
                      <input disabled={isReadOnly} type="text" name="plotId" value={formData.plotId} onChange={handleChange} placeholder="Gali lambarka" className="w-full p-3 text-[14px] bg-card-bg border border-border-color rounded-md focus:ring-2 focus:ring-navy/20 focus:border-navy outline-none font-medium text-text-main shadow-sm disabled:opacity-50" required />
                    </div>
                    <div>
                      <label className="block text-[12px] font-bold text-navy mb-2">Degmada</label>
                    ...
                    <div>
                      <label className="block text-[12px] font-bold text-navy mb-2">Baaxadda Dhulka</label>
                      <select disabled={isReadOnly} name="landArea" value={formData.landArea} onChange={handleChange} className="w-full p-3 text-[14px] bg-card-bg border border-border-color rounded-md focus:ring-2 focus:ring-navy/20 focus:border-navy outline-none text-text-main font-medium shadow-sm mb-3 disabled:opacity-50" required>
                        <option value="">Dooro Baaxadda</option>
                        <option value="100">Rubac (100 SQM)</option>
                        <option value="200">Nus Boos (200 SQM)</option>
                        <option value="300">Boos Buuxa (300 SQM)</option>
                        <option value="600">2 Boos (600 SQM)</option>
                        <option value="custom">+ Custom (Kale)</option>
                      </select>

                      {formData.landArea === 'custom' && (
                        <div className="relative animate-in slide-in-from-top-2 duration-300">
                          <input disabled={isReadOnly} type="number" name="customLandArea" value={formData.customLandArea} onChange={handleChange} placeholder="Gali SQM" className="w-full p-3 text-[14px] bg-card-bg border border-border-color rounded-md focus:ring-2 focus:ring-navy/20 focus:border-navy outline-none font-medium text-text-main shadow-sm pr-12 disabled:opacity-50" required />
                    ...
                    <div>
                      <label className="block text-[12px] font-bold text-navy mb-2">Nooca Dhismaha</label>
                      ...
                      {formData.buildingCategory === 'Dabaq' && (
                        <div className="animate-in slide-in-from-top-2 duration-300">
                          <input disabled={isReadOnly} type="number" name="floors" value={formData.floors} onChange={handleChange} placeholder="Tirada Dabaqyada" className="w-full p-3 text-[14px] bg-card-bg border border-border-color rounded-md focus:ring-2 focus:ring-navy/20 focus:border-navy outline-none font-medium text-text-main shadow-sm disabled:opacity-50" required min="1" />
                        </div>
                      )}
                    </div>
                  </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h3 className="text-[13px] font-bold text-[#a5c6ff] uppercase tracking-wider mb-1">
                          {viewingApp ? 'Lacagta la Saxay (Calculated Fee)' : 'Lacagta Fasaxa (Total Fee)'}
                        </h3>
                        {viewingApp ? (
                          <div className="flex items-center gap-2">
                            <span className="bg-emerald-500/20 text-emerald-400 text-[10px] px-2 py-0.5 rounded-full font-bold uppercase tracking-wider border border-emerald-500/30">
                              Horey u Bixiyay (Paid Already: ${viewingApp.formData.totalFee.toFixed(2)})
                            </span>
                          </div>
                        ) : (
                          <p className="text-[11px] text-gray-300 opacity-90 max-w-[200px] leading-relaxed hidden md:block">Lacagtaan waxaa loo xisaabiyay si toos ah iyadoo lagu saleynayo dhulka iyo nooca dhismaha.</p>
                        )}
                      </div>
                    </div>
                ...
                <section className="bg-card-bg rounded-[10px] shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)] border border-navy/10 overflow-hidden">
                  <div className="bg-table-header-bg border-b border-navy/10 px-6 py-4 flex items-center gap-3">
                    ...
                    <h2 className="font-bold text-[14px] text-navy tracking-wide">3. Qaybta Soo Gudbinta Dukumentiyada</h2>
                  </div>
                  <div className="p-4 sm:p-6 lg:p-8 space-y-4 lg:space-y-5">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 sm:p-5 border border-gray-200 rounded-lg shadow-[0_1px_2px_rgba(0,0,0,0.02)] gap-4 sm:gap-0">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-bold text-[13px] text-gray-800 tracking-wide">Baasaboor ama Aqoonsi Qaran <span className="text-red-500">*</span></p>
                          <p className="text-[11px] text-gray-400 font-medium mt-1 leading-snug break-words max-w-[200px] sm:max-w-none">{files.nationalId ? files.nationalId.name : 'Saar PDF, JPEG, ama PNG'}</p>
                        </div>
                      </div>
                      <label className="cursor-pointer bg-white text-[#002147] font-bold text-[12px] px-5 py-2.5 rounded-md flex items-center justify-center gap-2 transition-colors border border-gray-200 hover:bg-gray-50 shadow-sm tracking-wide w-full sm:w-auto">
                        <Upload size={14} strokeWidth={2.5} /> {files.nationalId ? 'Bedel' : 'Soo Raro'}
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 sm:p-5 border border-gray-200 rounded-lg shadow-[0_1px_2px_rgba(0,0,0,0.02)] gap-4 sm:gap-0">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-md flex items-center justify-center text-[#002147] bg-[#002147]/5 shrink-0"><FileText size={18} /></div>
                        <div>
                          <p className="font-bold text-[13px] text-gray-800 tracking-wide">Dukumentiga Lahaanshaha Dhulka <span className="text-red-500">*</span></p>
                          <p className="text-[11px] text-gray-400 font-medium mt-1 leading-snug break-words max-w-[200px] sm:max-w-none">{files.ownershipDocs ? files.ownershipDocs.name : 'Saar dukumentiga caddeyntaha (PDF)'}</p>
                        </div>
                      </div>
                      <label className="cursor-pointer bg-white text-[#002147] font-bold text-[12px] px-5 py-2.5 rounded-md flex items-center justify-center gap-2 transition-colors border border-gray-200 hover:bg-gray-50 shadow-sm tracking-wide w-full sm:w-auto">
                        <Upload size={14} strokeWidth={2.5} /> {files.ownershipDocs ? 'Bedel' : 'Soo Raro'}
                ...
                <section className="bg-card-bg rounded-[10px] shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)] border border-navy/10 overflow-hidden mb-12">
                  <div className="bg-table-header-bg border-b border-navy/10 px-6 py-4 flex items-center gap-3">
                    ...
                    <h2 className="font-bold text-[14px] text-navy tracking-wide">4. Caddayn & Saxiix</h2>
                  </div>
                  <div className="p-4 sm:p-6 lg:p-8">
                    {viewingApp && viewingApp.staffRemarks && (
                      <div className="mb-6 p-4 bg-orange-50 border border-orange-200 rounded-lg text-orange-800">
                        <h4 className="font-bold text-[13px] mb-1">Faallada Sarkaalka:</h4>
                    ...
                    <label className="flex items-start gap-4 cursor-pointer p-4 border border-gray-100 rounded-lg bg-gray-50/50 hover:bg-gray-50 transition-colors">
                      ...
                      <span className="text-[13px] text-gray-600 leading-relaxed font-medium block">
                        Waxaan caddaynayaa in dhammaan xogta aan bixiyay ay tahay mid sax ah. Waxaan la socdaa in macluumaad been abuur ah ay keeni karaan in codsigan la diido ama la iga qaado tillaabo sharci ah.
                      </span>
                    </label>
                    ...
                    <div className="mt-8 border-[1.5px] border-dashed border-navy/30 rounded-xl p-8 lg:p-12 flex flex-col items-center justify-center bg-table-header-bg/50">
                      ...
                      <p className="text-[10px] lg:text-[11px] font-bold text-navy/60 uppercase tracking-widest mb-6 text-center">Gali saxiixaaga</p>
                ...
                <div className="flex flex-col lg:flex-row justify-between items-center bg-card-bg p-4 lg:p-6 rounded-[10px] border border-border-color shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.1)] sticky bottom-0 lg:bottom-6 z-50 mt-12 gap-4 lg:gap-0 transition-colors duration-300">
                  <button type="button" onClick={closeForm} className="w-full lg:w-auto justify-center font-bold text-[13px] text-gray-500 hover:text-gray-800 transition-colors flex items-center gap-2"><ArrowLeft size={16} strokeWidth={2.5} /> Ku noqo Dashboard-ka</button>

                  {!isReadOnly && (
                    <div className="flex flex-row w-full lg:w-auto gap-2 sm:gap-4">
                      <button type="button" className="flex-1 lg:flex-none px-4 lg:px-6 py-3 text-[13px] font-bold text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-md transition-colors shadow-sm">Kaydi</button>
                      <button
                        type="submit"
                      ...
                      >
                        {isSubmitting ? 'Waala gudbinayaa...' : 'Gudbi Codsiga'}
                      </button>
                    </div>
                  )}
                </div>
      ...
      {showSuccess && (
        <div className="fixed inset-0 bg-navy/90 z-[100] flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-card-bg rounded-2xl w-full max-w-md p-10 text-center shadow-2xl animate-in zoom-in-95 duration-300 border border-white/20">
            ...
            <h2 className="text-[24px] font-bold text-navy mb-3">Codsiga waa la gudbiyay!</h2>
            <p className="text-[14px] text-text-muted mb-10 font-medium leading-relaxed px-4">Codsigaaga fasaxa dhismaha si guul leh ayaa loo gudbiyay dowladda hoose ee Muqdisho.</p>
            <button
